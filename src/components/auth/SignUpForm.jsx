export default function SignUpForm({ onSwitch, onSubmit }) {
  return (
    <form className="space-y-4" onSubmit={onSubmit}>
      <div>
        <label className="mb-2 block text-sm text-[#c9cbc4]" htmlFor="signup-name">
          الاسم الكامل
        </label>
        <input
          id="signup-name"
          type="text"
          placeholder="عبدالله ناصر"
      ...
      <div>
        <label className="mb-2 block text-sm text-[#c9cbc4]" htmlFor="signup-email">
          البريد الإلكتروني
        </label>
        <input
          id="signup-email"
      ...
      <div>
        <label className="mb-2 block text-sm text-[#c9cbc4]" htmlFor="signup-password">
          كلمة المرور
        </label>
        <input
          id="signup-password"
